(function(){'use strict';// these aren't really private, but nor are they really useful to document
...
console.log(`Time in Cairo is ${cairo.toFormat('HH:MM')}`);
...
// import snakeCase from 'voca/snakeCase';
// const testString = 'This is a simple string to test Voca'
// console.log(snakeCase(testString))
